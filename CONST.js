...
export const projects = [
	...
	},
	{
		...
		description: 'Virtual Playfest is part of Playfest. Playfest is annual event held by Narasi.tv that inviting artists, influencers, and a lot of inspirational person. Due to Covid-19, Virtual Playfest was held online. And this is the first time Virtual Playfest ',
		summary: 'Virtual Playfest is part of Playfest. Virtual Playfest 2020 id the first event that held online, contains a lot of amazing event.',
		navigation: '#',
		firstColor: '#7ED19A',
		secondColor: '#5198B7',
	...
	},
	{
		...
		description: 'IBAM is a series of conferences, talkshows with the community, and art installation exhibitions.',
		summary: 'IBAM is a series of conferences, talkshows with the community, and art installation exhibitions.',
		navigation: '#',
		firstColor: '#7ED19A',
		secondColor: '#5198B7',
		role: 'Frontend Developer',
	...
	},
	{
		...
		description: '1Medix App is pre-medical checkup for COVID-19. It allows user to books a SWAB / Rapid test based on nearest location.',
		summary: '1Medix App is pre-medical checkup for COVID-19. It allows user to books a SWAB / Rapid test based on nearest location.',
		navigation: '#',
		firstColor: '#FF9CE9',
		secondColor: '#8E64C4',
		role: 'Tech Leader',
...
export const hyperlink = [
	...
	},
	{
		img: 'email',
		label: 'Email',
		goto: 'https://mail.google.com/mail/u/0/?fs=1&to=mrizafauzi.r@gmail.com&tf=cm'
	},
	{
		img: 'linkedin',
		label: 'Linkedin',
